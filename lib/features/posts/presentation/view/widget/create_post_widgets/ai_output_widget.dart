        ...
        return Container(
          ...
          child: Padding(
            ...
            child: switch (state.status) {
              CubitStatus.initial => Text(
                AppLocaleKey.aiOutput.tr(),
                style: AppTextStyle.text14RDark(context),
              ),
              CubitStatus.loading => ZoomIn(child: const Text('typing...')),
              CubitStatus.failure => Text(
                AppLocaleKey.aiOutput.tr(),
                style: AppTextStyle.text14RDark(context),
              ),
              CubitStatus.success => SingleChildScrollView(
                child: FadeInRight(
                  child: Column(
                    ...
                    children: [
                      Text(
                        state.aiPromptResponseModel?.title ?? '',
                        style: AppTextStyle.text16BSecond(context),
                      ),
                      Text(
                        state.aiPromptResponseModel?.description ?? '',

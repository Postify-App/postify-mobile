...
class PostsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var businessId =
        context.read<ProfileCubit>().state.selectedBusiness?.id ?? '';
    return BlocProvider(
            ...
            SliverPadding(
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  24.verticalSpace,
                   ScheduledPostsListWidget(businessId: businessId,),
                  45.verticalSpace,
                  Text(
                    AppLocaleKey.posted.tr(),
                    style: AppTextStyle.text32BDark(
                      context,
                    ).copyWith(height: 1),
                  ),
                ]),
             ...
             CustomPostedListWidget(businessId: businessId,),
          ],
        ),
      ),
    );
